...
DEFAULT_THINKING_MESSAGES = [
    "See if the query is related to livekit...",
    "One moment while I check...",
    "Check if the retreived information is related to the query...",
    "recheck the generated response...",
    "Generate new response in case descripencies were found ..."
]
